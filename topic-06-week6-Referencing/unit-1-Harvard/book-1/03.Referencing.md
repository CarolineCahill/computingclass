...
+ You should add an automated **Table of Contents**

(RECALL: Make use of Heading 1 styled text - this is all that's needed to generate an auto TOC)

+ You should have an automated **Table of Figures**

(RECALL: Make use of Captions to label objects - this is all that's needed to generate an auto TOF)

+ Your name should be in the document **header**
+ Your course should be in the document **footer** along with the page numbers
+ Upload your completed file to the Area in Moodle
